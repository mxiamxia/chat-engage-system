...
var TEMP = {
    ...
    loginReq: '<message> <header> <action value="login" /> <userid value="%s" /> <sessionid value="%s" /> <orgid value="cyberobject" /> <appid value="ntelagent" /> <debugid value="" />  </header> <body> <usertype value="customer" /> <channel value="CCSA" /> </body> </message>',
