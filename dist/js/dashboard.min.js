...
function MasterCtrl(e,o,n,t){var s=992;e.sessionData=[],e.currentSession=[],e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(n,t){n>=s?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()};var r=function(){t.getHistorySession().success(function(o){e.sessionData=o}).error(function(e){console.log("Error: "+e)})};r();var i=function(){t.getCurrentSessions().success(function(o){e.currentSession=o}).error(function(e){console.log("Error: "+e)})};i(),e.refreshSessions=function(){t.getHistorySession().success(function(o){e.sessionData=o}).error(function(e){console.log("Error: "+e)})},e.deleteSession=function(e){console.log("delete session="+e)},e.refreshCurrentSessions=function(){i()}}app.controller("MasterCtrl",["$scope","$cookieStore","$http","Session",MasterCtrl]);
...
app.factory("Session",["$http",function(t){return{getActiveSessions:function(){var e={method:"GET",url:"/api/getActiveSession"};return t(e)},getHistorySession:function(){var e={method:"GET",url:"/api/getHistorySession"};return t(e)},getCurrentSessions:function(){var e={method:"GET",url:"/api/getAllSessionKey"};return t(e)}}}]);