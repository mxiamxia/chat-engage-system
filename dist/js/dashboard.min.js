...
function MasterCtrl(e,o,n,s){var t=992;e.sessionData=[],e.currentSession=[],e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(n,s){n>=t?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()};var r=function(){s.getHistorySession().success(function(o){e.sessionData=o}).error(function(e){console.log("Error: "+e)})};r();var i=function(){s.getCurrentSessions().success(function(o){e.currentSession=o}).error(function(e){console.log("Error: "+e)})};i(),e.refreshSessions=function(){s.getHistorySession().success(function(o){e.sessionData=o}).error(function(e){console.log("Error: "+e)})},e.deleteSession=function(e){console.log("delete session="+e),s.deleteSession(e).success(function(){console.log("delete session="+e)}).error(function(e){console.log("Error: "+e)})},e.refreshCurrentSessions=function(){i()}}app.controller("MasterCtrl",["$scope","$cookieStore","$http","Session",MasterCtrl]);
...
app.factory("Session",["$http",function(e){return{getActiveSessions:function(){var t={method:"GET",url:"/api/getActiveSession"};return e(t)},getHistorySession:function(){var t={method:"GET",url:"/api/getHistorySession"};return e(t)},getCurrentSessions:function(){var t={method:"GET",url:"/api/getAllSessionKey"};return e(t)},deleteSession:function(t){var n={sessionId:t},s={method:"POST",url:"/api/deleteSession",data:n};return e(s)}}}]);